...
import 'package:flutter_money/drop_select_menu/drop_select_object.dart';
import 'package:flutter_money/drop_select_menu/expand_widget.dart';
...
class DropSelectExpandedListMenu<T extends DropSelectObject>
  ...
  DropSelectExpandedListMenu(
      ...
      this.itemExtent = kDropExpendedSelectMenuItemHeight}) : super(key: key);
